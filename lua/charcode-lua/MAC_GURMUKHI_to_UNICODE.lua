-- adapted from https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/GURMUKHI.TXT
local mapping_MAC_GURMUKHI_to_UNICODE = {
	[0xE8+0xE8] = { 0x0A4D, 0x200C },	-- GURMUKHI SIGN VIRAMA + ZWNJ 
	[0xE8+0xE9] = { 0x0A4D, 0x200D },	-- GURMUKHI SIGN VIRAMA + ZWJ 
	[0x20] = 0x0020,	-- SPACE
	...
	[0xE8] = 0x0A4D,	-- GURMUKHI SIGN VIRAMA 
...
return mapping_MAC_GURMUKHI_to_UNICODE
