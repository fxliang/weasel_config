-- adapted from https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/THAI.TXT
local mapping_MAC_THAI_to_UNICODE = {
	[0x20] = 0x0020,	-- SPACE
...
return mapping_MAC_THAI_to_UNICODE
