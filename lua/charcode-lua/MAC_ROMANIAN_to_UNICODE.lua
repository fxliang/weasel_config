-- adapted from https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/ROMANIAN.TXT
local mapping_MAC_ROMANIAN_to_UNICODE = {
	[0x20] = 0x0020,	-- SPACE
...
return mapping_MAC_ROMANIAN_to_UNICODE
