-- adapted from https://www.unicode.org/Public/MAPPINGS/VENDORS/APPLE/CELTIC.TXT
local mapping_MAC_CELTIC_to_UNICODE = {
	[0x20] = 0x0020,	-- SPACE
	...
	[0xF0] = 0x2663,	-- BLACK CLUB SUIT = shamrock 
...
return mapping_MAC_CELTIC_to_UNICODE
